const I18N = {
  fr: {
    ...
    "hero.available": "Disponible dès le 1er Septembre 2026 — Recherche un CDI",
    ...
    "about.p1": "Développeur web full-stack à l’aise aussi bien côté frontend (TypeScript, Angular) que backend (Spring Boot, Node.js/Express) et bases de données (PostgreSQL, MySQL, Elasticsearch). J’ai consolidé ces compétences en entreprise et tout au long de ma formation, à laquelle j’ai ajouté une dimension DevOps et DevSecOps : CI/CD, Docker, Azure et monitoring.",
    "about.p2": "En fin d'études et à la recherche d'un CDI, je cherche à rejoindre une équipe ambitieuse où je pourrai continuer à progresser. Curieux par nature, je suis de près les évolutions de l'IA et leur impact sur nos métiers et nos pratiques de développement.",
  ...
  en: {
    ...
    "hero.available": "Available from September 1st, 2026 — Looking for a permanent position",
    "hero.title.line1": "Full-Stack", "hero.title.line2": "Web Developer",
    "hero.subtitle": "I build end-to-end web applications — TypeScript, Angular, Spring Boot, Node.js — and automate their delivery with DevOps and DevSecOps practices.",
    "hero.cta.projects": "View my work", "hero.cta.contact": "Get in touch",
    "about.eyebrow": "About", "about.title": "A few words about me",
    "about.p1": "Full-stack web developer equally comfortable with frontend (TypeScript, Angular), backend (Spring Boot, Node.js/Express), and databases (PostgreSQL, MySQL, Elasticsearch). I honed these skills through work experience and my formal education, which also included DevOps and DevSecOps expertise: CI/CD, Docker, Azure, and monitoring.",
    "about.p2": "Finishing my studies and looking for a permanent position, I'm eager to join an ambitious team where I can keep growing. Naturally curious, I closely follow the evolution of AI and its impact on our industry and development practices.",
